...
export default function Hero() {
  return (
    <section id="hero" className="relative overflow-hidden border-b border-zinc-200">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-24 lg:px-8 lg:pb-28 lg:pt-28">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-10">
          <div className="soft-rise lg:col-span-6">
            ...
            <h1 className="font-display mt-6 text-[2.35rem] font-bold leading-[1.02] tracking-[-0.03em] text-zinc-950 sm:text-[3.25rem] lg:text-[3.75rem]">
